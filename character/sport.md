...
| Джерело | Деталі |
| --- | --- |
| Мапа | Бліп спортзалу (наприклад, **Muscle Sands** — `-1205, -1572`) |
...
| --- | --- | --- | --- |
| ![](../.gitbook/assets/protein.png) Протеїн | **1 000$** | +**10%** до приросту | спад на **20%** повільніший |
| ![](../.gitbook/assets/creatine.png) Креатин | **2 000$** | +**50%** до приросту | спад на **20%** повільніший |
| ![](../.gitbook/assets/preworkout.png) Преворкаут | **3 000$** | +**25%** до приросту | спад у **2 рази** повільніший |
...
**F1** → **Про мене** → **Фізуха** → **Стати** — вікно з поточними показниками (також працює **`/mystats`**).
