...
Натисніть **`Tab`** — відкриється вікно інвентаря з вашим персонажем. **Лівий клік** <img src="../.gitbook/assets/inputs/mouse-lmb.svg" alt="ЛКМ" data-size="line"> бере, кладе й перетягує предмети між слотами; **ПКМ** <img src="../.gitbook/assets/inputs/mouse-rmb.svg" alt="ПКМ" data-size="line"> на предметі відкриває контекстне меню дій. Перетягніть потрібну річ на швидку панель (`Z`) — і матимете доступ до неї без відкриття повного інвентаря.

### Дії з предметом (ПКМ <img src="../.gitbook/assets/inputs/mouse-rmb.svg" alt="ПКМ" data-size="line">)
