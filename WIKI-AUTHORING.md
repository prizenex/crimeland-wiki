...
- **Таблиці з предметами** — **окрема колонка під іконку** (порожній заголовок), `width="36"`, назва в **наступній** колонці: `| | Предмет | … |` → `| <img src="…" width="36"> | **Назва** | … |`. Еталон: `crime/weed.md`, `crime/heisenberg.md`.
