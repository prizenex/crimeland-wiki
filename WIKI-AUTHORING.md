...
- **У таблицях** — іконка **inline** в клітинці з назвою: `| <img src="…" data-size="line"> **Назва** | … |`. Еталон: `crime/coke.md`, `crime/atms.md`.
...
- **Не** `width="36"` / `data-size="original"` / голий `![](path)` у таблицях — розмір неконтрольований.
- Шлях лише через `.gitbook/assets/`, не `growing/` чи інші підпапки.
- **Поза таблицею** (списки, кроки рецепту) — той самий `data-size="line"`.
