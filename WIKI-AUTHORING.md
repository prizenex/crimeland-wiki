...
1. **Короткий вступ** — що це і навіщо гравцю (1–3 речення, без води)
2. **Покрокові блоки** — `###` заголовки + нумеровані списки для дій
...
5. **`{% hint style="info" %}`** — один нюанс на hint, не дублюй абзац над ним
