...
- **У таблицях** — **окрема колонка** лише для іконки (без заголовка), назва — **наступною** колонкою. Еталон: `crime/weed.md` → «Гровінг у горщику».
- Синтаксис: `| <img src="../.gitbook/assets/<item>.png" alt="…" width="36"> | **Назва** | … |`
- **Не** став іконку й текст **в одну клітинку** — GitBook роздуває картинку (як було в «Добрива» до фіксу).
- **Не** `data-size="line"` у колонці іконки — буде занадто дрібно. **Не** `data-size="original"` / голий `![](path)`.
