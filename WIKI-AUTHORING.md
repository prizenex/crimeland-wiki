...
- **Таблиці з предметами** — іконка **в тій самій клітинці**, що й назва: `| <img src="…" width="36"> **Назва** | … |`. **Не** роби окрему порожню колонку під іконку — GitBook показує її як «Text» і вмикає database block із пошуком.
