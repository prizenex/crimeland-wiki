...
Пограбування банків на CrimeLand — це **контрактні місії** через [планшет контрактів](contract-tablet.md). Три рівні складності: **Fleeca** (малі відділення), **Paleto** (північний банк) та **Pacific** (центральний банк). Кожен контракт купується за **Gcoin**, вимагає команду, мінімум поліції онлайн і спеціальне обладнання.
...
| Банк | Gcoin (купівля) | Команда | Поліція | Досвід (репутація) | Кулдаун |
| --- | --- | --- | --- | --- | --- |
