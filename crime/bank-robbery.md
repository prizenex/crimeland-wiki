...
Зібрали команду й трохи спорядження? Купуйте контракт у [планшеті](contract-tablet.md) і йдіть на наліт — **Fleeca** для перших грошей, **Paleto** й **Pacific** для серйозного улову. Чим складніший банк, тим більша потрібна команда, більше поліції онлайн і серйозніше обладнання.
...
- **Старт** — купіть контракт у **планшеті**, зберіть команду й приїдьте на мітку
...
- **Нагорода** — **мічені купюри**, золоті злитки, рідкісний лут; купюри треба [відмити](money-laundering.md)
- **Час очікування** — після успіху той самий банк недоступний певний час (див. таблицю нижче)

---

## Порівняння банків

| Банк | Gcoin (купівля) | Команда | Поліція | Досвід (репутація) | Час очікування |
| --- | --- | --- | --- | --- | --- |
...
Після успіху додатково: **Gcoin** на планшет (125 / 250 / 325 відповідно).
...
| Іконка | Предмет | Fleeca | Paleto | Pacific |
| --- | --- | --- | --- | --- |
...
| Іконка | Тип | Мічені купюри | Золото (20% шанс) |
| --- | --- | --- | --- |
...
2. Вставте **USB** у термінал, зайдіть у кімнату спостереження й перегляньте камери (лобі, офіси, коридор).
3. Зламайте **офісні двері** та **комп’ютер** (USB витрачається).
4. Відкрийте **сейф у офісі** — готівка $20k–40k + документи.
5. Застосуйте **підроблену картку** на панелі сховища й забирайте візки.
...
Спочатку проходите **вхід** (USB і відбиток пальця), далі **офіси** з USB і кодами, потім **головний офіс** із сейфом. У **підвалі** потрібна **синя ключ-картка** — там **сховище**, **депозитні комірки** і вихід.
...
3. **Головний офіс** — введіть код з кейпада й відкрийте сейф з цінностями.
...
У сховищі — **мічені купюри**, їх треба [відмити](money-laundering.md). Золото здається в ломбард (**$5 000**/злиток) без відмивки.
...
Лут розділяйте **IC** — за домовленістю чи ролями. Мічені пачки не носіть відкрито: для копів це прямий доказ, тож відмийте їх через [склад](money-laundering.md) або зону банди якнайшвидше. Той самий банк після успіху стане недоступним на певний час — плануйте наступний контракт (Fleeca, cargo або [казино](casino-robbery.md)).
