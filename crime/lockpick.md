...
| Предмет | Для чого |
| --- | --- |
| <img src="../.gitbook/assets/lockpick.png" alt="Звичайна відмичка" data-size="line"> Звичайна відмичка | Авто, чужі склади [відмивки](money-laundering.md), прості замки |
| <img src="../.gitbook/assets/lockpick_house.png" alt="Набір для відмикання" data-size="line"> Набір для відмикання | [Пограбування будинків](houses.md) за контрактом — **усі рівні** житла |
...
| Що потрібно | Деталі |
| --- | --- |
| <img src="../.gitbook/assets/hack_usb.png" alt="Фантомний USB" data-size="line"> Фантомний USB | Замість відмички — **складніша міні-гра** на злам |
