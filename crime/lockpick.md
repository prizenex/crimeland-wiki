...
| Предмет | Для чого |
| --- | --- |
| <img src="../.gitbook/assets/lockpick.png" alt="Звичайна відмичка" width="24"> Звичайна відмичка | Авто, чужі склади [відмивки](money-laundering.md), прості замки |
| <img src="../.gitbook/assets/lockpick_house.png" alt="Набір для відмикання" width="24"> Набір для відмикання | [Пограбування будинків](houses.md) за контрактом — **усі рівні** житла |
...
| Що потрібно | Деталі |
| --- | --- |
| <img src="../.gitbook/assets/hack_usb.png" alt="Фантомний USB" width="24"> Фантомний USB | Замість відмички — **складніша міні-гра** на злам |
...
<p align="center">
<img src="../.gitbook/assets/lockpick_house.png" alt="Набір для відмикання" width="24">
</p>
