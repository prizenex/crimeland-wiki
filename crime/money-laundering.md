---
description: Мічені купюри, склад-пральня (5 етапів) або зона банди «Відмивання» — курси та покращення.
icon: sack-dollar
---

# Відмивка грошей

Готівка з [пограбувань](twenty-four-seven.md), [банкоматів](atms.md) та контрактів часто приходить **міченими купюрами** — їх не приймуть у банку. **Відмивка** перетворює «брудні» кошти на **легальну готівку** для [гаманця](../basics/documents.md) або рахунку.

Два шляхи: власний **склад-пральня** (повний цикл) або **зона «Відмивання»** банди (швидкий обмін).
...
Точка продажу — **ангар аеропорту Сенді Шорс** (пустеля, схід штату). Усередині ангару стоїть **продавець** — підійдіть до NPC і відкрийте меню продажу.
...
Порядок суворий: спочатку **знімаєте мітки** з мічених купюр, потім **перете**, **сушите** і лише наприкінці **перераховуєте** — на виході отримуєте **чисту готівку**.
...
Три точки всередині складу — **завантажити** мокрі гроші, **увімкнути** цикл, **зібрати** <img src="../.gitbook/assets/dry_money.png" alt="сухі гроші" data-size="line"> сухі гроші. Є звичайна та покращена сушарка (після апгрейду).

#### Етап 4. Перерахунок (столи лічильників) — **в кінці**

| Іконка | Вхід | Вихід | Ліміт за раз |
| --- | --- | --- | --- |
...
- Спочатку купіть **ноутбук** і **локатор** — без них склад важко знайти й захистити.
- Не тягніть **мічені купюри** в банк — вони не конвертуються автоматично.
- Робіть відмивку **невеликими партіями**, якщо поруч активна поліція.
- Поєднуйте з [збутом](illegal-sales.md) та [контрактами](contract-tablet.md) для стабільного доходу.
