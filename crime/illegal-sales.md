...
- **<img src="../.gitbook/assets/cokebaggy.png" alt="Пакет кокаїну" width="36">**; Предмет: **Пакет кокаїну**; Мін: $220; Оптимум: $350; Макс: $480; Макс. за раз: 6 шт.
...
- **Вхідний поріг**; Вуличний збут: Низький; Зона збуту (банда): Потрібен контроль території
- **Ціна**; Вуличний збут: Середня, залежить від клієнта; Зона збуту (банда): Фіксована, часто вища
- **Ризик поліції**; Вуличний збут: Постійний; Зона збуту (банда): Нижчий
- **Час**; Вуличний збут: Миттєво; Зона збуту (банда): Часто з затримкою (склад зони)
