...
Швидкий спосіб перетворити наркотики на готівку — продати їх прямо NPC-клієнтам на вулиці. Підходить для [трави](weed.md), [коксу](coke.md), [мету](heisenberg.md) та інших нелегальних предметів у [інвентарі](../character/inventory.md). Гроші з угод одразу чисті; якщо паралельно маєте мічені купюри з інших джерел — [відмийте](money-laundering.md) їх окремо.
...
| Іконка | Предмет | Мін | Оптимум | Макс | Макс. за раз |
| --- | --- | --- | --- | --- | --- |
...
| Іконка | Якість | Мін | Оптимум | Макс | Макс. за раз |
| --- | --- | --- | --- | --- | --- |
...
- Починайте з **дешевих косяків** — менші втрати при крадіжці.
- У центрі міста більше **снітчів і копів** — краще район з біженцями або промзона.
- Не продавайте **всю партію одному** «залежному» — 50% шанс крадіжки.
- Поєднуйте з [відмивкою](money-laundering.md), якщо паралельно заробляєте міченими купюрами.
- Легальна альтернатива — [цивільні роботи](../jobs/builder.md).
