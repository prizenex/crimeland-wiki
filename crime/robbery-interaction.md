...
| Крайм-інструменти | <p>USB</p>![](../.gitbook/assets/hack_usb.png), <p>картка</p>![](../.gitbook/assets/hack_card.png), дрилі, терміт |
| Цінності | <p>Мічені купюри</p>![](../.gitbook/assets/markedbills.png), золото, коштовності |
| Зброя | Пістолети, гвинтівки (з списку сервера) |
| Розхідники | <p>Відмичка</p>![](../.gitbook/assets/lockpick.png), рація, телефон |
...
| Дія | Для чого |
| --- | --- |
| <p>Стяжки</p><p>![](../.gitbook/assets/ziptie.png)</p> | Скрутити руки — RP-утримання, **не замінює** обшук |
