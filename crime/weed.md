...
{% hint style="success" %}
Точні **мітки на карті** — у **Джессі** в таборі хіппі ![](../.gitbook/assets/blips/280.png): у меню **«Марихуана»** оберіть **«Домашній гровінг»**. Можна одразу поставити waypoint — не треба шукати продавців наосліп.
{% endhint %}
...
| **Комахи** | <img src="../.gitbook/assets/kq_weed_pesticide_spray.png" alt="Засіб від комах" data-size="line"> **Засіб від комах** — обприскуйте одразу після появи; без лікування кущ гине за **~5 хв**. |
...
| Іконка | Сорт | Ріст (база) | \~У тенті | Полив не рідше ніж | Вікно збору після дозрівання |
| --- | --- | --- | --- | --- | --- |
...
- **Рецепт пакування** — з **1** дикої трави й **1** порожнього пакета виходить **1** упакована дика трава (\~**5 сек**)
...
Маршрути полів дикої трави: у **Джессі** відкрийте **«Марихуана»** і оберіть **Маршрут 1**, **2** або **3**.

## Сорти

- **Звичайні** — OG Kush, White Widow, Purple Haze. Стартові для першого циклу мутацій.
- **Рідкісні** — Blue Dream, AK47. Швидше ростуть, кращий урожай.
- **Епічний** — Amnesia. З нього єдиний шлях до MAC1.
- **Легендарний** — MAC1. Найшвидший ріст і найбільший урожай.
...
Шанс нового насіння після збору — за сортом врожаю:

| Зібрано | Можливі мутації |
| --- | --- |
...
Потрібен максимальний прибуток — обирайте добриво врожайності; важлива швидкість — прискорювач росту.
