...
| Предмет | Призначення |
| --- | --- |
| <img src="growing/kq_weed_pot.png" alt="Горщик для вирощування" data-size="line"> | Горщик для посадки рослини. |
| <img src="growing/kq_weed_tent.png" alt="Гроу-тент" data-size="line"> | Гроу-тент створює умови для домашнього вирощування. |
| <img src="growing/kq_weed_watering_system.png" alt="Система автополиву" data-size="line"> | Автоматично підтримує вологу, зокрема коли ви офлайн. |
...
| **Комахи** | <img src="growing/kq_weed_pesticide_spray.png" alt="Засіб від комах" data-size="line"> Обприскуйте одразу після появи — без лікування кущ гине за **~5 хв**. |
...
| Добриво | Ефект |
| --- | --- |
| <img src="growing/kq_weed_fertilizer_speed.png" alt="Прискорювач росту" data-size="line"> **Прискорювач росту** | Прискорює ріст, але збільшує споживання води та трохи знижує врожайність і стійкість. |
| <img src="growing/kq_weed_fertilizer_yield.png" alt="Добриво врожайності" data-size="line"> **Добриво врожайності** | Значно збільшує врожай, але сповільнює ріст і підвищує потребу у воді. |
