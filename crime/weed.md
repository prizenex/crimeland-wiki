...
| Предмет                                                                                                                         | Призначення                                           |
| ------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| <img src="../.gitbook/assets/kq_weed_pot (1).png" alt="Горщик для вирощування" data-size="line"> **Горщик для вирощування**     | Для посадки рослини.                                  |
| <img src="../.gitbook/assets/kq_weed_tent (1).png" alt="Гроу-тент" data-size="line"> **Гроу-тент**                              | Створює умови для домашнього вирощування.             |
| <img src="../.gitbook/assets/kq_weed_watering_system (1).png" alt="Система автополиву" data-size="line"> **Система автополиву** | Автоматично підтримує вологу, зокрема коли ви офлайн. |
...
| **Комахи** | <img src="../.gitbook/assets/kq_weed_pesticide_spray (1).png" alt="Засіб від комах" data-size="line"> **Засіб від комах** — обприскуйте одразу після появи; без лікування кущ гине за **\~5 хв**. |
...
| Добриво                                                                                                                                      | Ефект                                                                                                               |
| -------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| <img src="../.gitbook/assets/kq_weed_fertilizer_speed (1).png" alt="Прискорювач росту" data-size="line"> **Прискорювач росту**               | Прискорює ріст, але збільшує споживання води та трохи знижує врожайність і стійкість.                               |
| <img src="../.gitbook/assets/kq_weed_fertilizer_yield (1).png" alt="Добриво врожайності" data-size="line"> **Добриво врожайності**           | Значно збільшує врожай, але сповільнює ріст і підвищує потребу у воді.                                              |
