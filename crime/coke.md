...
| Етап | Де | Час |
| --- | --- | --- |
| 1. Сировина | Збір / крафт / закупівля IC | — |
...
| Предмет | Опис |
| --- | --- |
| <img src="../.gitbook/assets/coca_leaf.png" alt="Листя коки" data-size="line"> Листя коки | Сировина для першої переробки |

**Звідки взяти:**

- Збір у відкритому світі (локації змінюються — уточнюйте IC у крайм-середовищі).
