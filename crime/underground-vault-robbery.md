...
**Union** — командна операція з **підземним сховищем** у місті. Старт у **пустелі біля Lester**: збір команди на дошці, спецтранспорт, **трос**, **C4**, **злом USB** і до **$1 200 000** готівки на команду.
...
2. Один гравець **на сторожі** біля виходу — LSPD часто піджимає в кінці.
3. Готівка **чиста** — [відмивка](money-laundering.md) не потрібна, якщо не несете паралельно мічені купюри.
4. Кулдаун **5 хв** — можна повторити, але район запам’ятають.
