...
| ---: | --- | --- |
| 1 | <img src="../.gitbook/assets/kq_meth_lab_kit.png" alt="Набір" width="36"> **Набір для приготування метамфетаміну** | Точка збору на заході штату (маршрут від Джессі) — **може бути охорона** |
| 1 | <img src="../.gitbook/assets/kq_ammonia.png" alt="Амоніак" width="36"> **Амоніак** | **Цистерни** — 3 біля Humane Labs + 1 у доках LS |
| 1 | <img src="../.gitbook/assets/kq_acetone.png" alt="Ацетон" width="36"> **Ацетон** | Склад біля Sandy Shores (разом з етанолом і псевдоефедрином) |
...
| **3** | <img src="../.gitbook/assets/kq_lithium.png" alt="Літій" width="36"> **Літієвий пакет** | Купи **старих акумуляторів** (дають кілька пакетів за раз) |
