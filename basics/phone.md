...
- **Праця** — вакансії та працевлаштування
...
Якщо телефон розрядився, підзарядіть його павербанком <img src="../.gitbook/assets/powerbank.png" alt="" data-size="line"> — купіть у **«Діджитал Ден»** (див. [Магазини](shops.md)) і використайте предмет в інвентарі.
...
- **Меню не відкривається** — перевірте, чи є предмет **«Телефон»** в інвентарі
...
- **Не бачите переказ** — перевірте, чи одержувач доданий у **контакти**
