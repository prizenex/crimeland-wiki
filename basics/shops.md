...
Приїдьте до магазину, підійдіть до каси чи точки продажу і відкрийте меню через **`E`** / **`лівий Alt`** ([Керування](controls.md)) або підказку на екрані. У магазинах гравців оберіть **категорію**, тоді додайте товар і кількість, перевірте **ціну** й **спосіб оплати** та підтвердьте покупку. Перевірте [інвентар](../character/inventory.md) — предмет має з'явитися у слотах.
...
Максимум **3** власні магазини і **2** наймані працівники (окрім власних точок). Панель власника відкривається у службовій зоні: `E` → **«Відкрити панель власника»** (одна дія в меню). Товар потрібно **закуповувати і доставляти** самостійно — без цього полиці порожні. Детальніше про ведення бізнесу — у розділі [Магазин 24/7](../business/twenty-four-seven.md).
